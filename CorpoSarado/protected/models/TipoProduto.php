 ...
 *
 * The followings are the available columns in table 'tipo_produto':
...
class TipoProduto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cod_tipo, descricao', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fornecedors' => array(self::MANY_MANY, 'Fornecedor', 'fornece_produto(cod_produto, cod_fornecedor)'),
			'produtos' => array(self::HAS_MANY, 'Produto', 'cod_tipo'),
		);
	}
